...
const actions = [
  { icon: DollarSign, label: 'Buy/Sell Crypto', color: 'from-green-600 to-emerald-600' },
  { icon: ArrowLeftRight, label: 'Swap Crypto', color: 'from-blue-600 to-indigo-600' },
  { icon: PiggyBank, label: 'Lending', color: 'from-purple-600 to-indigo-600' },
  { icon: Landmark, label: 'Borrowing', color: 'from-pink-600 to-purple-600' },
  { icon: Users, label: 'Pay Employees', color: 'from-indigo-600 to-purple-600' },
  { icon: UserPlus, label: 'Add Employee', color: 'from-violet-600 to-indigo-600' },
];
