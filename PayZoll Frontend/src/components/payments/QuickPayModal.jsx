          ...
          <div className="p-6">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-2xl font-bold text-indigo-400">$145,678</div>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-sm text-gray-400 mt-1">All Departments</div>
                </div>
              </div>
            ...
            <label className="flex items-start space-x-3 mb-6">
              ...
              <span className="text-sm text-gray-400">
                I confirm that I want to process payments for all active employees and understand
