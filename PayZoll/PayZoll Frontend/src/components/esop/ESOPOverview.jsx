...
export default function ESOPOverview() {
  const stats = [
    {
      ...
      {stats.map((stat, index) => (
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${stat.color} flex items-center justify-center transform transition-transform group-hover:scale-110`}>
