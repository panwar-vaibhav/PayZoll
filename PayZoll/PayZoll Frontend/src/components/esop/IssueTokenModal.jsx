...
import { 
  X, User, Calendar, Coins, 
  AlertCircle, Calculator 
} from 'lucide-react';

export default function IssueTokenModal({ isOpen, onClose }) {
        ...
        >
          ...
          <div className="p-6">
            ...
            <div className="space-y-4 mb-6">
              <label className="block text-sm text-gray-400">Select Employee</label>
            ...
            {/* Token Amount */}
            <div className="space-y-4 mb-6">
              <label className="block text-sm text-gray-400">Number of Tokens</label>
              <div className="relative">
            ...
            <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, vestingEnd: e.target.value })}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm text-gray-400 mb-1">Cliff Period (months)</label>
                  <select
                ...
                <div>
                  <label className="block text-sm text-gray-400 mb-1">Vesting Frequency</label>
                  <select
                    className="w-full bg-crypto-dark border border-gray-800 rounded-xl py-2 px-4
                             focus:outline-none focus:border-indigo-500 transition-colors"
                    value={formData.vestingFrequency}
                    onChange={(e) => setFormData({ ...formData, vestingFrequency: e.target.value })}
                  >
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-yellow-200/80 mt-1">
                    This action will create a new token grant contract. Please ensure all details
                    are correct as this action cannot be undone.
                  </p>
                </div>
              </div>
            </div>
