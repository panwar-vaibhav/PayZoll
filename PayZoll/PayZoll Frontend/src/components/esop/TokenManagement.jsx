    ...
    <div className="bg-crypto-card border border-gray-800 rounded-xl p-6 hover:border-indigo-500/50 transition-all">
        ...
        <div className="bg-crypto-dark rounded-xl p-4 border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xl font-bold text-white mt-1">1,000,000</div>
            </div>
        ...
        <div className="bg-crypto-dark rounded-xl p-4 border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xl font-bold text-green-400 mt-1">750,000</div>
            </div>
        ...
        <div className="bg-crypto-dark rounded-xl p-4 border border-gray-800">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-xl font-bold text-yellow-400 mt-1">250,000</div>
            </div>
        ...
        <table className="w-full">
          <thead className="bg-crypto-dark/90 backdrop-blur-sm">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">Allocated</th>
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">Claimed</th>
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">Remaining</th>
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-400">Vesting End</th>
          ...
          <tbody className="divide-y divide-gray-800">
            {employees.map((employee) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-gray-400">{employee.department}</td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-400">{employee.allocated}</td>
                <td className="px-6 py-4 whitespace-nowrap text-green-400">{employee.claimed}</td>
                <td className="px-6 py-4 whitespace-nowrap text-yellow-400">{employee.remaining}</td>
                <td className="px-6 py-4 whitespace-nowrap text-gray-400">{employee.vestingEnd}</td>
                <td className="px-6 py-4 whitespace-nowrap">
      ...
      <div className="mt-4 flex items-center justify-between text-sm">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button className="px-4 py-2 text-gray-400 hover:text-white transition-colors">2</button>
          <button className="px-4 py-2 text-gray-400 hover:text-white transition-colors">3</button>
          <button className="px-4 py-2 text-gray-400 hover:text-white transition-colors">Next</button>
        </div>
      </div>
    </div>
  );
