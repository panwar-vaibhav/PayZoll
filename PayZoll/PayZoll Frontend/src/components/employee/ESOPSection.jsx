  ...
  return (
    <div className="bg-crypto-card border border-gray-800 rounded-xl p-6 hover:border-indigo-500/50 transition-all">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 
        ...
        <div className="bg-crypto-dark rounded-xl p-4 border border-gray-800">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <div className="text-2xl font-bold">10,000 ESOP</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-lg font-semibold text-green-400">6,000 ESOP</div>
            </div>
            <div>
              <div className="text-sm text-gray-400">Locked</div>
              <div className="text-lg font-semibold text-yellow-400">4,000 ESOP</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-crypto-dark rounded-xl p-4 border border-gray-800">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="text-lg font-semibold text-indigo-400">$3.50</div>
            </div>
            <div>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-gray-400">1,000 ESOP on Feb 1, 2024</div>
            </div>
          </div>
