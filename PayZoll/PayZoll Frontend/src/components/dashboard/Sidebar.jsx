...
export default function Sidebar({ isWalletConnected, onConnectWallet }) {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-crypto-card border-r border-gray-800">
      <div className="flex flex-col h-full">
        ...
        {/* Logout */}
        <button className="flex items-center space-x-3 px-8 py-6 text-gray-400 hover:text-white transition-colors border-t border-gray-800">
