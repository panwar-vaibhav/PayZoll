...
export default function EmployerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-crypto-dark text-white flex">
      ...
      {/* Sidebar */}
      <Sidebar isWalletConnected={isWalletConnected} onConnectWallet={() => setIsWalletConnected(true)} />

      {/* Main Content */}
      <main className="flex-1 ml-64 p-8 relative">
        <div className="max-w-[1600px] mx-auto space-y-6">
          {/* Quick Actions */}
          <QuickActions isWalletConnected={isWalletConnected} />
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            >
              <BalanceSection isWalletConnected={isWalletConnected} />
            </motion.div>
